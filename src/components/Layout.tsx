...
export const NAV: NavItem[] = [
  ...
  { to: '/front-desk',label: 'Front Desk',       icon: '🛎️', roles: ['reception'] },
  { to: '/my-day',    label: 'My Day',           icon: '📋', roles: ['therapist'] },
  { to: '/clinical',  label: 'Clinical',         icon: '🩺', roles: ['senior'] },
  { to: '/leads',     label: 'Leads & Intake',   icon: '📥', roles: ['admin', 'reception'] },
  { to: '/schedule',  label: 'Schedule',         icon: '🗓️', roles: ['admin', 'senior', 'therapist', 'reception'] },
  { to: '/clients',   label: 'Clients & Children', icon: '👨‍👩‍👧', roles: ['admin', 'senior', 'therapist', 'reception'] },
